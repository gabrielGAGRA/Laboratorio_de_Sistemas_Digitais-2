---
description: Use when reading or modifying Verilog RTL modules — structural hierarchy, top-level interconnects, Control Unit (FSM), Datapath, and memory submodules.
paths:
  - "**/*.v"
  - "**/*.sv"
---
