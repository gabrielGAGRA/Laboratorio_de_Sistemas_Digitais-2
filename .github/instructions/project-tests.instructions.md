---
description: Use when writing, running, or debugging Verilog testbenches, simulation commands, and stimulus generation.
applyTo: tb/**/*.v,**/*_tb.v,**/tb_*.v
---

# Testbenches & Simulation

- **Testbench Scope:** Every non-trivial module should have an accompanying self-checking testbench (`tb_<module>.v`).
...
- **Fast Simulation:** Override real-time constants (e.g., set debouncer modulus to 5 cycles instead of `100_000`) to avoid stalled simulations.
